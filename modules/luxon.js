...
export var luxon = (function (e) {
  ...
  const at = (function () {
    function e(e, t, n) {
      ...
      (this.opts = n),
        e.zone.isUniversal
          ? ((i =
              (i = (e.offset / 60) * -1) >= 0 ? `Etc/GMT+${i}` : `Etc/GMT${i}`),
            e.offset !== 0 && qe.create(i).valid
              ? ((r = i), (this.dt = e))
              : ((r = "UTC"),
                n.timeZoneName
                  ? (this.dt = e)
  ...
  var ct = (function () {
    ...
    return (
      ...
      (e.eras = function (e, t) {
        const n = this;
        return ot(this, e, (t = void 0 === t ? !0 : t), Ee, () => {
          const t = { era: e };
          return (
            n.eraCache[e] ||
  ...
  var mt = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/;
  const yt = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/;
  var n = RegExp(`${yt.source}${mt.source}?`);
  var w = RegExp(`(?:T${n.source})?`);
  var g = ht("weekYear", "weekNumber", "weekDay");
  var T = ht("year", "ordinal");
  var mt = RegExp(`${yt.source} ?(?:${mt.source}|(${ye.source}))?`);
  var ye = RegExp(`(?: ${mt.source})?`);
  function vt(e, t, n) {
    t = e[t];
    return W(t) ? n : X(t);
  }
  ...
  function Dt(e) {
    ...
    const l = e[10];
    var e = e[11];
    var a = Mt(t, i, r, n, o, u, a);
    var e = s ? Ot[s] : c ? 0 : le(l, e);
    return [a, new Ue(e)];
  }
  const Et =
  ...
  const Ft = lt(/([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, w);
  const Lt = lt(/(\d{4})-?W(\d\d)(?:-?(\d))?/, w);
  const Zt = lt(/(\d{4})-?(\d{3})/, w);
  const At = lt(n);
  const zt = ft(pt, gt, wt);
  const jt = ft(g, gt, wt);
  const qt = ft(T, gt, wt);
  const _t = ft(gt, wt);
  const Ut = ft(gt);
  const Rt = lt(/(\d{4})-(\d\d)-(\d\d)/, ye);
  const Ht = lt(mt);
  const Pt = ft(pt, gt, wt, kt);
  const Wt = ft(gt, wt, kt);
  var T = {
    weeks: {
      days: 7,
      hours: 168,
  ...
  function Qt(e, t, n, r, i) {
    ...
    var u = t[n] / o;
    var u =
      !(Math.sign(u) === Math.sign(r[i])) && r[i] !== 0 && Math.abs(u) <= 1
        ? (e = u) < 0
          ? Math.floor(e)
          : Math.ceil(e)
        : Math.trunc(u);
  ...
  var Kt = (function () {
    ...
    return (
      ...
      (e.set = function (e) {
        return this.isValid
          ? Bt(this, { values: { ...this.values, ...de(e, m.normalizeUnit) } })
          : this;
      }),
  ...
  const an = on.hanidec.replace(/[\[|\]]/g, "").split("");
  function sn(e, t) {
    e = e.numberingSystem;
    return void 0 === t && (t = ""), new RegExp(`${on[e || "latn"]}${t}`);
  }
  const cn = "missing Intl.DateTimeFormat.formatToParts support";
  function ln(e, t) {
    return (
      void 0 === t &&
        (t = function (e) {
            ...
            (function (e) {
              ...
              if (isNaN(t)) {
                for (var t = "", n = 0; n < e.length; n++) {
                  ...
                  if (e[n].search(on.hanidec) !== -1) t += an.indexOf(e[n]);
                  else {
                    for (var i in un) {
                      var o = un[i];
                      var i = o[0];
  ...
  const fn = `( |${String.fromCharCode(160)})`;
  const dn = new RegExp(fn, "g");
  function hn(e) {
  ...
  function yn(n, r) {
    return n === null
      ...
      : {
          ...
          deser(e) {
            const t = e[0];
            return n.findIndex((e) => mn(t) === mn(e)) + r;
          },
        };
  }
  function vn(e, t) {
  ...
  const On = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
  function Mn(e, t) {
    return new Ce(
      "unit out of range",
  ...
  function xn(e) {
    const t = e.year;
    return { year: t, ordinal: Dn(t, e.month, e.day), ...me(e) };
  }
  function Cn(e) {
    const t = e.year;
    const n = En(t, e.ordinal);
    return {
      year: t,
      month: n.month,
      day: n.day,
  ...
  function zn(e) {
    return e.weekData === null && (e.weekData = Vn(e.c)), e.weekData;
  }
  function jn(e, t) {
    e = {
      ts: e.ts,
  ...
  function Hn(e, t, n, r, i, o) {
    ...
    if (e && Object.keys(e).length !== 0) {
      o = rr.fromObject(e, { ...n, zone: t || a, specificOffset: o });
  ...
  const Kn = ["year", "ordinal", "hour", "minute", "second", "millisecond"];
  function Xn(e) {
    const t = {
      year: "year",
      years: "year",
  ...
  function er(e, t) {
    const n = He(t.zone, Be.defaultZone);
    const r = ct.fromObject(t);
    var t = Be.now();
    if (W(e.year)) a = t;
    else {
      for (let i = k(Bn); !(o = i()).done; ) {
        var o = o.value;
        W(e[o]) && (e[o] = Yn[o]);
      }
      var u = Fn(e) || Ln(e);
  ...
  var rr = (function () {
    ...
    (w.now = function () {
      ...
      (w.fromISO = function (e, t) {
        void 0 === t && (t = {});
        const n = dt(e, [Ft, zt], [Lt, jt], [Zt, qt], [At, _t]);
    ...
    return (
      ...
      (e.toISO = function (e) {
        ...
        var t = void 0 === e || e;
        if (!this.isValid) return null;
        (e = (void 0 === n ? "extended" : n) === "extended"), (n = Wn(this, e));
        return (n += "T"), (n += Jn(this, e, i, r, t));
      }),
      (e.toISODate = function (e) {
        e = (void 0 === e ? {} : e).format;
        return this.isValid
          ? Wn(this, (void 0 === e ? "extended" : e) === "extended")
          : null;
      }),
      ...
      (e.diff = function (e, t, n) {
        ...
        var t = ((n = t), (Array.isArray(n) ? n : [n]).map(Kt.normalizeUnit));
        var n = e.valueOf() > this.valueOf();
        var r = rn(n ? this : e, n ? e : this, t, r);
        return n ? r.negate() : r;
      }),
      ...
      (e.toRelativeCalendar = function (e) {
        return (
          void 0 === e && (e = {}),
          this.isValid
            ? tr(e.base || w.fromObject({}, { zone: this.zone }), this, {
                ...e,
                numeric: "auto",
